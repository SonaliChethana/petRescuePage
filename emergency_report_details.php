...
$query = "SELECT * FROM emergencyreport WHERE id = ? AND user_id = ?";
...
$photos = unserialize($report['photos']);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <?php if (!empty($photos)): ?>
        ...
        <?php foreach ($photos as $photo): ?>
            <img src="<?php echo htmlspecialchars($photo); ?>" alt="Emergency Photo" width="200px">
        <?php endforeach; ?>
        </div>
        </div>
    <?php endif; ?>

    <a href="emergency_reports.php" class="button">Back to Your Reports</a>
    </div>
